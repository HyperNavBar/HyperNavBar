...
import cn.ianzb.hypernavbar.AppIdentifyAccessibilityService
...
class FloatingIdentifyService : Service() {
    ...
    companion object {
        const val ACTION_QUICK_ADD = "cn.ianzb.hypernavbar.QUICK_ADD_APP"
    ...
    private fun startForegroundNotification() {
        ...
        val pi = PendingIntent.getActivity(
            this, 0,
            Intent(this, cn.ianzb.hypernavbar.MainActivity::class.java),
    ...
    private fun onQuickAdd() {
        ...
        val launchIntent = Intent(this, cn.ianzb.hypernavbar.MainActivity::class.java).apply {
